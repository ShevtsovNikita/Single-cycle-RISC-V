...
Затем коды операций переписал в [memory_test.mem](memory_test.mem) для исполнения процессором, в тестбенче просто задал тактирование и, сверяя данные на времянке с состояниями регистров при выполненнии программы на ассемблере, убедился в правильности работы.
